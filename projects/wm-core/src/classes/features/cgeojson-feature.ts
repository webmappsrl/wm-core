...
import { EGeojsonGeometryTypes } from 'wm-core/src/types/egeojson-geometry-types.enum';
import { IGeojsonFeature,IGeojsonProperties,IGeojsonGeometry } from 'wm-core/src/types/model';
