export const wmIT = {
  ...
  'distance': 'Distanza',
  'Posizione GPS non aggiornata': 'Posizione GPS non aggiornata',
  'al termine del percorso': 'al termine del percorso',
  'del percorso completato': 'del percorso completato',
  ...
  'touring-bike': 'Bici da turismo',
  'train-trekking': 'Treno trekking',
  'road-bike': 'Bici da strada',
  'ciaspole': 'Ciaspole',
  'adventure': 'Avventura',
  'swimming-snorkeling': 'Nuoto e snorkeling',
  'birdwatching': 'Birdwatching',
  'oeno-gastronomy': 'Oeno-gastronomia',
