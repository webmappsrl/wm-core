export const wmPR = {
  ...
  'descent': 'Elevação -',
  'distance': 'Distância',
  'Posizione GPS non aggiornata': 'Posição GPS não atualizada',
  'al termine del percorso': 'até o fim do percurso',
  'del percorso completato': 'do percurso percorrido',
  ...
  'Mostra altro': 'Mostrar mais',
  'Distanza da te': 'Distância de ti',
  ...
  'Hai salvato correttamente il tuo waypoint. Puoi visualizzarlo accedendo al tuo profilo.':
    'Você salvou corretamente o seu waypoint. Você pode visualizá-lo acessando o seu perfil.',
  'Cliccando su "Registrati" accetti la nostra privacy e i termini e condizioni':
    'Ao clicar em "Registrar" aceita a nossa política de privacidade e os nossos termos e condições',
