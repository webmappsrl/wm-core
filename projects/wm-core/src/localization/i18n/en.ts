export const wmEN = {
  ...
  'descent': 'Slope -',
  'distance': 'Distance',
  'Posizione GPS non aggiornata': 'GPS position not updated',
  'al termine del percorso': 'to the end of the route',
  'del percorso completato': 'of the route covered',
  ...
  'train-trekking': 'Train trekking',
  'road-bike': 'Road bike',
  'ciaspole': 'Snowshoes',
  'adventure': 'Adventure',
  'swimming-snorkeling': 'Swimming and Snorkeling',
  'birdwatching': 'Birdwatching',
  'oeno-gastronomy': 'Oeno-gastronomy',
