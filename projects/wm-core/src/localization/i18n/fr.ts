export const wmFR = {
  ...
  'distance': 'Distance',
  'Posizione GPS non aggiornata': 'Position GPS non mise à jour',
  'al termine del percorso': 'jusqu\'à la fin du parcours',
  'del percorso completato': 'du parcours effectué',
  ...
  'touring-bike': 'Vélo de tourisme',
  'train-trekking': 'Randonnée en train',
  'road-bike': 'Vélo de route',
  'ciaspole': 'Raquettes à neige',
  'adventure': 'Aventure',
  'swimming-snorkeling': 'Natation et snorkeling',
  'birdwatching': 'Observation des oiseaux',
  'oeno-gastronomy': 'Oeno-gastronomie',
