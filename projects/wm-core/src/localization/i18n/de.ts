export const wmDE = {
  ...
  'descent': 'Abstieg -',
  'distance': 'Entfernung',
  'Posizione GPS non aggiornata': 'GPS-Position nicht aktualisiert',
  'al termine del percorso': 'bis zum Ende der Strecke',
  'del percorso completato': 'der Strecke zurückgelegt',
  'ele_from': 'Start-Höhe',
  'ele_max': 'Max-Höhe',
  'ele_min': 'Min-Höhe',
  'ele_to': 'Ziel-Höhe',
