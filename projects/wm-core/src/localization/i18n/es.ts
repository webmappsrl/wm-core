export const wmES = {
  ...
  'descent': 'Descenso -',
  'distance': 'Distancia',
  'Posizione GPS non aggiornata': 'Posición GPS no actualizada',
  'al termine del percorso': 'hasta el final de la ruta',
  'del percorso completato': 'de la ruta recorrida',
  ...
  'Quota': 'Elevación',
  'I miei downloads': 'Mis descargas',
