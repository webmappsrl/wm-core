export const wmSQ = {
  ...
  'descent': 'Zbritje',
  'distance': 'Distanca',
  'Posizione GPS non aggiornata': 'Pozicioni GPS nuk është përditësuar',
  'al termine del percorso': 'deri në fund të itinerarit',
  'del percorso completato': 'e itinerarit të përshkuar',
  ...
  'Quota': 'Lartësia',
  'I miei downloads': 'Shkarkimet e mia',
  'foto dalla galleria': 'foto nga galeria',
  'Dimensione massime: 3 photo': 'Madhësia maksimale: 3 foto',
  'Aggiungi': 'Shto',
  'Foto': 'Foto',
  '(max 3 photo)': '(maks 3 foto)',
  'art-and-culture': 'Artë dhe kulturë',
  'tourism': 'Turizëm',
  'e-bike': 'Biçikletë elektrike',
  'touring-bike': 'Biçikletë turistike',
  'train-trekking': 'Trekking me tren',
  'road-bike': 'Biçikletë rrugore',
  'ciaspole': 'Shkopinj dëbore',
  'adventure': 'Aventurë',
  'swimming-snorkeling': 'Not dhe snorkeling',
  'birdwatching': 'Vëzhgimi i zogjve',
  'oeno-gastronomy': 'Eno-gastronomia',
  'nordic-walking': 'Ecje nordike',
  'joelette': 'Joëlette',
  'mtb': 'MTB',
